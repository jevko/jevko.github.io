var editorBundle = (function (exports) {
        ...
        parser: parser$1.configure({
            props: [
                indentNodeProp.add({
                    ...
                    // Subjevko: delimitedIndent({closing: "]"}),
                    // Subjevko: continuedIndent({except: /^\s*\]/}),
                    // 'Jevko': continuedIndent({except: /^\s*\]/}),
                    'Subjevko': (context) => {
                        // let matchExcept = except && except.test(context.textAfter)
                    ...
                    // Jevko: (context) => {
                    //   // let matchExcept = except && except.test(context.textAfter)
                    //   return context.baseIndent + (1 * context.unit)
                    // },
                    // Text: (context) => {
                    //   // let matchExcept = except && except.test(context.textAfter)
                    //   return context.baseIndent + (1 * context.unit)
    ...
    */
    ...
    exports.makeJevkoEditor = makeJevkoEditor;
    exports.makeJsonEditor = makeJsonEditor;
